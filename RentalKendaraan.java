...
public class RentalKendaraan {
    ...
    static void showTransaksiRental() {
        ...
        System.out.println("+--------------------------------------+---------------------+-------------------+-------------+--------------+");
        System.out.println("| No TNKB     | Nama Kendaraan         | Nama Peminjam       | Lama Pinjam       | Total Biaya                |");
        System.out.println("+--------------------------------------+---------------------+-------------------+-------------+--------------+");
        for (TransaksiRental transaksiRental : transaksiRentals) {
            System.out.printf("| %-12s | %-20s | %-17s | %-11d | %-12.0f |\n",
                    transaksiRental.br.noTNKB,
                    transaksiRental.br.namaKendaraan,
                    transaksiRental.namaPeminjam,
                    transaksiRental.lamaPinjam,
                    transaksiRental.totalBiaya);
        }
        System.out.println("+--------------------------------------+---------------------+-------------------+-------------+--------------+");
    }
